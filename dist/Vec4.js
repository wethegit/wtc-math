  ...
  * @param {number} y 				The y coord
  ...
  _createClass(Vec4, [{
    ...
    * @param {Vector} v 				The vector object to use to reset the coordinates
    ...
    value: function transformByMat4(m) {
      ...
      if (m instanceof Array && m.length >= 16) {
        ...
        this.y = (m[2] * o.x + m[6] * o.y + m[10] * o.z + m[14]) / this.w;
    ...
    value: function transformByQuat(q) {
      ...
      if (q instanceof Array && q.length >= 4) {
        var uv = new Vec4(q.w * this.x + q.y * this.z - q.z * this.y, q.w * this.y + q.z * this.x - q.x * this.z, q.w * this.z + q.x * this.y - q.y * this.x, -q.x * this.x - q.y * this.y - q.z * this.z);
    ...
    value: function cross(v, w) {
      ...
      var A = v[0] * w[1] - v[1] * w[0],
          ...
          I = u[2],
          J = u[3];
      return new Vec4(H * F - I * E + J * D, -(G * F) + I * C - J * B, G * E - H * C + J * A, -(G * D) + H * B - I * A);
    }
  }, {
    key: "crossNew",
    ...
    */
    ...
    key: "xyz",
    get: function get() {
      return new _Vec2["default"](this.x, this.y, this.z);
    },
    set: function set(v) {
      v = _Vec2["default"].interpolate(v);
      this.x = v.x;
      this.y = v.y;
      this.z = v.z;
    }
    ...
    key: "yzx",
    get: function get() {
      return new _Vec2["default"](this.y, this.z, this.x);
    },
    set: function set(v) {
      v = _Vec2["default"].interpolate(v);
      this.x = v.y;
    ...
    key: "zxy",
    get: function get() {
      return new _Vec2["default"](this.z, this.x, this.y);
    },
    set: function set(v) {
      v = _Vec2["default"].interpolate(v);
      this.x = v.z;
    ...
    key: "xz",
    get: function get() {
      return new _Vec["default"](this.x, this.z);
    },
    set: function set(v) {
      v = _Vec["default"].interpolate(v);
      this.x = v.x;
    ...
    key: "xw",
    get: function get() {
      return new _Vec["default"](this.x, this.w);
    },
    set: function set(v) {
      v = _Vec["default"].interpolate(v);
      this.x = v.x;
    ...
    key: "yw",
    get: function get() {
      return new _Vec["default"](this.y, this.w);
    },
    set: function set(v) {
      v = _Vec["default"].interpolate(v);
      this.y = v.x;
    ...
    key: "zw",
    get: function get() {
      return new _Vec["default"](this.z, this.w);
    },
    set: function set(v) {
      v = _Vec["default"].interpolate(v);
      this.z = v.x;
    ...
    key: "wx",
    get: function get() {
      return new _Vec["default"](this.w, this.x);
    },
    set: function set(v) {
      v = _Vec["default"].interpolate(v);
      this.w = v.x;
    ...
    key: "wy",
    get: function get() {
      return new _Vec["default"](this.w, this.y);
    },
    set: function set(v) {
      v = _Vec["default"].interpolate(v);
      this.w = v.x;
    ...
    key: "wz",
    get: function get() {
      return new _Vec["default"](this.w, this.z);
    },
    set: function set(v) {
      v = _Vec["default"].interpolate(v);
      this.w = v.x;
    ...
    key: "ww",
    get: function get() {
      return new _Vec["default"](this.w, this.w);
    },
    set: function set(v) {
      v = _Vec["default"].interpolate(v);
      this.w = v.y;
    ...
    value: function lerp(v1, v2, d) {
      return new Vec4(v1.x + d * (v2.x - v1.x), v1.y + d * (v2.y - v1.y), v1.z + d * (v2.z - v1.z), v1.w + d * (v2.w - v1.w));
    }
  }, {
    key: "getAngle",
